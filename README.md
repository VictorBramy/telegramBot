...
- 💹 **מדד פיננסי ישראלי** - מעקב בזמן אמת אחר מדד הפיננסים והמניות המובילות
- 🍔 **שוברי 10Bis** - הצגת שוברים פעילים עם ברקודים לסריקה
...
### 💹 מדד פיננסי ישראלי (חדש!)

- `/finance` - הצגת מדד הפיננסים הישראלי בזמן אמת
- `/financestock <symbol>` - מידע מפורט על מניה ישראלית

#### דוגמאות:

```
/finance                    # מדד פיננסים מלא
/financestock PHOE.TA      # פניקס
/financestock LUMI.TA      # לאומי
/financestock POLI.TA      # פועלים
```

**מניות במדד:** פניקס, פועלים, לאומי, מזרחי-טפחות, דיסקונט, הראל, מנורה, הבינלאומי, כלל ביטוח, מגדל, פיבי הולדינגס
